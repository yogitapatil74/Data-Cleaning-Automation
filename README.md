...
* **Object-Oriented Programming (OOP):** Used Classes to make the code reusable and modular.
* **Logging:** Integrated Python `logging` module to track script execution and errors in real-time.
* **Data Normalization:** Automated the handling of null values and column standardization.
